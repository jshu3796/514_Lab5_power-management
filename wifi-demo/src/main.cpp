...
const char* password = "-G/Crr6!iz"; // Replace with your network password
#define DATABASE_URL "https://esp32-firebase-demo-miko-default-rtdb.firebaseio.com/" // Replace with your database URL
#define API_KEY "AIzaSyDc1pGq7D2HtPSdzooKH3hhGGHBsTvl-5Q" // Replace with your API key
